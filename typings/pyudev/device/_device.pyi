...
class Devices:
    ...
    """
    @classmethod
    def from_path(cls, context, path): # -> Device:
        """
    ...
    @classmethod
    def from_sys_path(cls, context, sys_path): # -> Device:
        """
    ...
    @classmethod
    def from_name(cls, context, subsystem, sys_name): # -> Device:
        """
    ...
    @classmethod
    def from_device_number(cls, context, typ, number): # -> Device:
        """
    ...
    @classmethod
    def from_device_file(cls, context, filename): # -> Device:
        """
    ...
    @classmethod
    def from_kernel_device(cls, context, kernel_device): # -> Device:
        """
    ...
    @classmethod
    def from_environment(cls, context): # -> Device:
        """
...
class Device(collections.abc.Mapping):
    ...
    @property
    def ancestors(self): # -> Generator[Device, Any, None]:
        """
    ...
    def find_parent(self, subsystem, device_type=...): # -> Device | None:
        """
    ...
    def traverse(self): # -> Generator[Device, Any, None]:
        """
    ...
    @property
    def device_links(self): # -> Generator[Any | str, Any, None]:
        """
...
class Attributes:
    ...
    @property
    def available_attributes(self): # -> Generator[Any | str, Any, None]:
        """
    ...
    def asstring(self, attribute): # -> str:
        """
    ...
    def asbool(self, attribute): # -> bool:
        """
